...
var pathToTemplateFile = '../public/template_registration.html';
...
exports.handler = async (event, context) => {
  ...
  if(data) {
    // If matching data is found, read the template_registration.html file
    try {
      let html = await readFile(path.resolve(__dirname, pathToTemplateFile), 'utf8'); // Modify this line
